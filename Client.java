 ...
 * AP - 8A
 * 
 * This program is the implementation of Client Side of Login page of Hypothetical web site. This program contains the GUI screens for Menu, Login user, Change username and password of user.
 * 
 */
...
//class for implementing GUI for client side
public class Client extends JFrame implements ActionListener 
{
    ...
    {
        //Legend Message
        System.out.println("Welcome to Client Side of Login page of Hypotheticla web site. This program contains the GUI screens for Menu, Login user, Change username and password of user.");
