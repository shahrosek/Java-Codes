 ...
 * AP - 8A
 * 
 * This program is implementation of Server side of login page of hypothetical web site. It contains the functionalities of login, registration, changing old password and changing old username of a user. 
 * 
 */

//importing the libraries for implementing sockets and databases and user input.
import java.net.*;
import java.util.*;
import java.sql.*;
import java.io.*;

//class for server side of login page
public class LoginServer {
    ...
    //method for accepting requests from clients and calling appropriate method for logging, changing username or password and registering user
    public void serverRequest()
    {
        try
        {
            //opening server socket on port 2223
            ServerSocket ss = new ServerSocket(2223);
            
            //confirmation message for starting server
            System.out.println("Server Started");
            
            //loop for runing the server and accepting requests from client
            while(true)
            {
                //accpet client request
                Socket s = ss.accept();
                
                //confirmation message for client request accepted
    ...
    //default constructor for LoginServer class
    public LoginServer()
    {
        //initialize encrypt for encrypting passwords
        encrypt = Base64.getEncoder();
        
        //call serverRequest method for accepting requests from client
        serverRequest();
    }
    
    //main method of LoginServer class
    public static void main(String args[])
    {
        //Legend message of this program
        System.out.println("This is the Server side of Login page of Hypothetical website. It contains the functionality of Logging user, Registering user, Changing old password and username of existing user.");
        
        //Make an object of LoginServer class
